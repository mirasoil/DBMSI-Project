...
$selANDConditionField = ['cusLastName'];
$selANDConditionOperator = ['='];
$selANDConditionFieldSecondary = ['Pop'];
...
foreach ($cursor as $id => $value) {
    ...
    if(str_contains($newColl, 'FK') !== false) {
        ...
        $i++;
        $info = 'found-in-FK';
    } elseif (str_contains($newColl, 'NonUnique') !== false && !isset($selANDConditionField)) {
